...
public class TestPersonRepository {
		...
		@Test
		void testSaveData() {
			var joaq = new Person("Joaquin Phoenix", LocalDate.of(1974, 10, 28), Nationalities.ETATS_UNIEN);
			var gege = new Person ("Gérard Darmon", LocalDate.of(1948,  2, 29), Nationalities.FRANCAIS);
			var todd = new Person ("Todd Phillips", LocalDate.of(1970, 12, 20),Nationalities.ETATS_UNIEN);
